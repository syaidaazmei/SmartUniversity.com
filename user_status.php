...
// Get the user's booking data (assuming there's a user identifier in the session)
$user_name = mysqli_real_escape_string($con, $_SESSION['user_name']);

// Fetch data based on the logged-in user's name
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <h2 class="text-center">Your Booking Status</h2>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            <td><?php echo $no++; ?></td>
                            <td><?php echo htmlspecialchars($row['fakulti']); ?></td>
                            <td><?php echo htmlspecialchars($row['phone']); ?></td>
                            <td><?php echo htmlspecialchars($row['email']); ?></td>
                            <td><?php echo htmlspecialchars($row['matrik']); ?></td>
                            <td><?php echo htmlspecialchars($row['program']); ?></td>
                            <td><?php echo htmlspecialchars($row['kenderaan']); ?></td>
                            <td><?php echo htmlspecialchars($row['peserta']); ?></td>
                            <td><?php echo htmlspecialchars($row['date']); ?></td>
                            <td><?php echo htmlspecialchars($row['duration']); ?></td>
                            <td><?php echo htmlspecialchars($row['tempatmenunggu']); ?></td>
                            <td><?php echo htmlspecialchars($row['destinasi']); ?></td>
                            <td><?php echo htmlspecialchars($row['pengiring']); ?></td>
                            <td>
                                <?php
